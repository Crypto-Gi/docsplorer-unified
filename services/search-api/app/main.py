...
DEV_QDRANT_URL = os.getenv("QDRANT_DEV_URL", "")
DEV_QDRANT_API_KEY = os.getenv("QDRANT_DEV_API_KEY", "")
DEV_QDRANT_VERIFY_SSL = os.getenv("QDRANT_DEV_VERIFY_SSL", "false").lower() == "true"

# Production environment configuration
PROD_QDRANT_URL = os.getenv("QDRANT_PROD_URL", "")
PROD_QDRANT_API_KEY = os.getenv("QDRANT_PROD_API_KEY", "")
PROD_QDRANT_VERIFY_SSL = os.getenv("QDRANT_PROD_VERIFY_SSL", "true").lower() == "true"
...
# Embedding configuration (provider-specific)
DEFAULT_EMBEDDING_MODEL = os.getenv("OLLAMA_EMBEDDING_MODEL", "bge-m3")
DEFAULT_VECTOR_SIZE = int(os.getenv("OLLAMA_EMBEDDING_DIMENSIONS", "1024"))

# API Key Authentication
API_KEY = os.getenv("SEARCH_API_KEY", "")
API_KEY_ENABLED = os.getenv("SEARCH_API_KEY_ENABLED", "false").lower() == "true"
# ===============================
